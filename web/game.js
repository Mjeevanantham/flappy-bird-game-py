...
class Game {
  ...
  start(){ this.playing=true; this.gameOver=false; this.score=0; this.bird=new Bird(); this.pipes=[]; this.lastPipe=performance.now();
  ...
  draw(){ const ctx = this.ctx; ctx.clearRect(0,0,SCREEN_W,SCREEN_H);
    // sky and ground
